    ...
    'sections' => [
        'app' => [
            ...
            'inputs' => [
                ...
                [
                    'name' => 'motto', // unique key for setting
                    'type' => 'text', // type of input can be text, number, textarea, select, boolean, checkbox etc.
                    'label' => 'App Motto', // label for input
                    // optional properties
                    'placeholder' => 'Application Motto', // placeholder for input
                    'class' => 'form-control', // override global input_class
                    'style' => '', // any inline styles
                    'rules' => 'nullable|min:5|max:100', // validation rules for this input
                    'value' => '...premium health care', // any default value
                    'hint' => 'You can set the app motto here' // help block text for input
                ]
            ]
        ],
        'fees' => [
