...
class DoctorPasswordChangeNotification extends Notification //implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ->subject('Doctor Account Password Change')
            ->line($this->user->name .', your doctor\'s administration account password update was successful.')
    ...
    public function toArray($notifiable)
    {
        ...
        $message  = $timestamp .' - <strong>Doctor Account Password Change.</strong> <br>';
        $message.= $this->user->name .', your doctor\'s administration account password update was successful. <br>';
