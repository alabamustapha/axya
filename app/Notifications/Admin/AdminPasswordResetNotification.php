...
class AdminPasswordResetNotification extends Notification //implements ShouldQueue
{
    ...
    public function toMail($notifiable)
    {
        ...
        $resetEmailLink = route('admin.password.reset-email-verify', [
                                'token' => $token, 
        ...
        return (new MailMessage)
            ...
            ->line('Click the button below to reset your administrator account password.')
    ...
    public function toArray($notifiable)
    {
        ...
        $message  = $timestamp .' - <strong>Admin Account Password Reset.</strong> <br>';
        $message .= 'An administrator account password reset email was sent to you. Check your email inbox.<br>';
