    ...
    <nav id="sidebar">
        ...
        @if (Auth::user()->is_authenticated_admin)
            ...
            <li class="nav-item">
                ...
                <a class="nav-link" href="{{route('dashboard-doctors')}}">
                    <span class="icon">
            ...
            <li class="nav-item">
                ...
                <a class="nav-link" href="{{ route('adm_subscriptions') }}">
                    <span class="icon">
                        <svg width="25" height="20" viewBox="0 0 13 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M2.80177 7.75873V6.56738C2.28434 7.00231 1.73702 7.40041 1.16382 7.75873H2.80177Z" fill="white" />
                            <path fill-rule="evenodd" clip-rule="evenodd"
                                d="M3.87928 0H8.62066C8.85869 0 9.05169 0.192997 9.05169 0.431034V8.18965C9.05169 8.42769 8.85869 8.62069 8.62066 8.62069H3.87928C3.64124 8.62069 3.44824 8.42769 3.44824 8.18965V0.431034C3.44824 0.192997 3.64124 0 3.87928 0ZM5.38795 6.25H7.11209C7.35013 6.25 7.54312 6.443 7.54312 6.68103C7.54312 6.91907 7.35013 7.11207 7.11209 7.11207H5.38795C5.14991 7.11207 4.95692 6.91907 4.95692 6.68103C4.95692 6.443 5.14991 6.25 5.38795 6.25ZM5.38795 0.860861H4.95692V1.2919H5.38795V0.860861ZM5.81897 0.860861H7.54311V1.2919H5.81897V0.860861ZM4.74131 1.93933H4.31028V2.80139H4.74131V1.93933ZM5.17233 1.93933H5.60337V2.80139H5.17233V1.93933ZM6.46549 1.93933H6.03445V2.80139H6.46549V1.93933ZM6.89657 1.93933H7.32761V2.80139H6.89657V1.93933ZM8.18973 1.93933H7.7587V2.80139H8.18973V1.93933ZM6.03445 3.44875H7.54307V3.87979H6.03445V3.44875ZM5.60347 3.44875H4.95692V3.87979H5.60347V3.44875ZM4.95692 4.31067H7.54312V4.74171H4.95692V4.31067ZM7.11208 5.17154H5.38794V5.60257H7.11208V5.17154Z"
                                fill="white" />
                            <path fill-rule="evenodd" clip-rule="evenodd"
                                d="M0.431034 0.861328C0.192997 0.861328 0 1.05433 0 1.29236V7.32685C0 7.56488 0.192997 7.75788 0.431034 7.75788H2.80172V6.68005H1.5087C1.27067 6.68005 1.07767 6.48705 1.07767 6.24901C1.07767 6.01097 1.27067 5.81798 1.5087 5.81798H2.80172V5.17373H1.93972V4.7427H2.80172V4.30969H1.5087V3.87865H2.80172V3.23232H2.37075V2.58577H2.80172V0.861328H0.431034ZM2.80169 1.5073H2.15514V1.93834H2.80169V1.5073ZM0.646575 2.58577H1.07761V3.23232H0.646575V2.58577ZM1.93973 2.58577H1.5087V3.23232H1.93973V2.58577ZM1.72412 1.5073H1.29308V1.93834H1.72412V1.5073Z"
                                fill="white" />
                            <path fill-rule="evenodd" clip-rule="evenodd"
                                d="M12.0689 7.75788H9.69824V6.68005H10.9913C11.2294 6.68005 11.4224 6.48705 11.4224 6.24901C11.4224 6.01097 11.2294 5.81798 10.9913 5.81798H9.69824V5.17373H10.3448V4.7427H9.69824V4.30969H10.7758V3.87865H9.69824V3.23232H10.1293V2.58577H9.69824V1.93834H11.2068V1.5073H9.69824V0.861328H12.0689C12.307 0.861328 12.5 1.05433 12.5 1.29236V7.32685C12.5 7.56488 12.307 7.75788 12.0689 7.75788ZM11.8534 2.58577H11.4223V3.23232H11.8534V2.58577ZM10.5603 2.58577H10.9913V3.23232H10.5603V2.58577Z"
                                fill="white" />
                        </svg>


                    </span>
                    <span class="navlink-active">Subscription</span>
                </a>
            </li>

            <li class="nav-item">
            
                <a class="nav-link" href="{{ route('adm_transactions') }}">
                    <span class="icon">
            ...
            <li class="nav-item">
                ...
                <a class="nav-link" href="{
10.7505 8.4735 10.7695 8.4735 10.7882 8.47078C10.9038 8.47219 10.9986 8.37965 11 8.26409C11.0004 8.22972 10.9923 8.19577 10.9765 8.16528ZM8.40069 1.8732C8.43835 1.83527 8.46006 1.78435 8.46137 1.73091L8.47811 1.17222L9.66454 0.467057L10.1667 0.969251L9.47622 2.15359L8.90707 2.17452C8.85363 2.17583 8.8027 2.19753 8.76478 2.2352L6.21196 4.78593L5.85205 4.42602L8.40069 1.8732ZM1.14398 10.2117L0.426258 9.49818L2.91421 7.01651L3.27412 7.37641L3.61728 7.73213L1.14398 10.2117ZM4.20527 7.70075L3.92906 7.42245L3.82235 7.31573L2.94351 6.43061L3.15275 6.22137L4.40824 7.49359L4.20527 7.70075ZM4.24503 6.74658L3.88512 6.38667L4.5589 5.71289L4.91881 6.0728L4.24503 6.74658ZM9.66873 7.75306C9.60663 7.73637 9.5426 7.72792 9.47831 7.72795C9.02213 7.76478 8.64558 8.09947 8.55553 8.5482C8.48412 8.80019 8.49809 9.06873 8.59529 9.31195C8.68498 9.54602 8.8795 9.72428 9.1205 9.79322L9.8989 10.0025C9.18908 10.4254 8.27077 10.1929 7.8478 9.48312C7.64915 9.14976 7.58781 8.75227 7.67669 8.37452C7.69262 8.30427 7.67128 8.23075 7.62019 8.17992L2.90375 3.4593C2.83679 3.39639 2.73664 3.38452 2.65684 3.43C2.44076 3.54402 2.20015 3.60365 1.95586 3.60368C1.32631 3.60423 0.763983 3.21008 0.549714 2.61812L1.0268 2.88387C1.13801 2.94614 1.26343 2.97858 1.39089 2.97803C1.77831 2.95572 2.12483 2.72949 2.30112 2.38377C2.58569 1.87529 2.47479 1.27057 2.0563 1.03621L1.44739 0.690952C2.22553 0.412993 3.08164 0.818488 3.3596 1.5966C3.45606 1.86669 3.47288 2.1588 3.40804 2.43817C3.39211 2.50842 3.41345 2.58195 3.46453 2.63277L8.19144 7.35758C8.25604 7.42226 8.35518 7.43754 8.43626 7.39525C8.65236 7.28131 8.89294 7.2217 9.13724 7.22157C9.66711 7.22115 10.1576 7.50141 10.4262 7.95812L9.66873 7.75306Z"
                                fill="white" />
                        </svg>


                    </span>
                    <span class="navlink-active">Tools & Settings</span>
                </a>
            </li>
            ...
            <li class="nav-item bg-danger">
                ...
                <a class="nav-link" href="#" 
                    ...
                    <span class="navlink-active">&nbsp;{{ __('Logout') }}</span>
                </a>
                            ...
                            <div class="collapse opt-menu shadow-lg" id="optDropdown" style="z-index: 10000;">
                                <div class="opt-items">
                                    <div class="extra-opt-items">
                                        <a href="{{route('home')}}" class="opt-item">Home</a>                        
                                    </div>

                                    <a href="{{route('users.show', Auth::user())}}" class="opt-item">Profile</a>

                                    @if (Auth::user()->isAdmin())
                                        <a href="{{route('dashboard-main')}}" class="opt-item">Admin Dashboard</a>
                                    @endif
