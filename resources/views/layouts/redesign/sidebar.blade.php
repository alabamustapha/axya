...
<ul class="nav flex-sm-column">
      ...
      <li class="nav-item">
        ...
        <ul id="doctorSubmenu" class=" collapse sub-menu nav flex-sm-column">
          <li class="nav-item">
            ...
            <a href="{{route('dr_appointments')}}" class="nav-link">
              <span class="icon">
            ...
            <a href="{{route('dr_prescriptions')}}" class="nav-link">
              <span class="icon">
            ...
            <a href="{{route('dr_transactions', Auth::user())}}" class="nav-link">
              <span class="icon">
                <i class="fa fa-handshake"></i>
              </span>
            ...
            <a href="{{route('subscriptions.index', Auth::user())}}" class="nav-link">
              <span class="icon">
      ...
      <ul id="appointmentSubmenu" class=" collapse sub-menu nav flex-sm-column">
        <li class="nav-item">
          ...
          <a href="{{route('appointments.index')}}" class="nav-link">
            ...
            <span class="navlink-active">All</span>
          </a>

          <a href="{{route('appointments.index', ['status' => 'awaiting-appointment-time'])}}" class="nav-link">
            <span class="icon">
              <i class="fa fa-calendar-plus"></i>
            </span>
            <span class="navlink-active">Upcoming</span>
          </a>

          <a href="{{route('appointments.index', ['status' => 'awaiting-confirmation'])}}" class="nav-link">
            <span class="icon">
              <i class="fa fa-calendar"></i>
            </span>
            <span class="navlink-active">Pending</span>
          </a>
          ...
          <a href="{{route('appointments.index', ['status' => 'success'])}}" class="nav-link">
            ...
            <span class="navlink-active">Past</span>
          </a>
        </li>
      </ul>
    </li>
    ...
    <li class="nav-item">
        ...
        <a class="nav-link" href="{{route('transactions.index', Auth::user())}}">
            <span class="icon">
