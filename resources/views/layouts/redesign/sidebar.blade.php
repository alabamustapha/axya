<div class="sidebar-header ">
              ...
              <ul class="nav flex-sm-column">
                  ...
                  <li class="nav-item">
                      ...
                      <a class="nav-link" href="{{route('subscriptions.index', Auth::user())}}">
                          <span class="icon">
                              <svg width="20" height="26" viewBox="0 0 20 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                                  <path d="M10.0002 5.83984C6.8411 774 12.7083 12.1354 12.7083 12.4389C12.7085 12.7972 12.6445 13.1023 12.517 13.3541Z"
                                      fill="white" />
                                  <path d="M9.9.50972 9.47656 9.61285 9.47656 9.78886Z"
                                      fill="white" />
                                  <path d="M10.6348 9 12.527 10.7095 12.4526 10.6348 12.3888Z"
                                      fill="white" />
                                  <path d="M19.2188 4.0625C17.352 4.0625 15.8333 2.58177 15.8333 0.761719V0H4.16667V0.761719C4.16667 2.58177 2.64797 4.0625 0.78125 4.0625H0V16.5513L9.0887 26H10.9113L20 "
                                      fill="white" />
                              </svg>
                  ...
                  <li class="nav-item">
                      ...
                      <a class="nav-link" href="{{route('adm_subscriptions')}}">
                          <span class="icon">
                              <svg width="20" height="26" viewBox="0 0 20 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                                  <path d="M10.0002 15.7293 14.5059 7293 8.3457 13.1595 13.1023 12.517 13.3541Z"
                                      fill="white" />
                                  <path d="M19.2188 4.0625C17.352 4.0625 15.8333 2.58177 15.8333 0.761719V0H4.16667V0.761719C4.16667 2.58177 2.64797 4.0625 0.78125 4.0625H0V16.5513L9.0887 26H10.9113L20 "
                                      fill="white" />
                              </svg>
                          ...
                          <span class="navlink-active">Admin Subs DB</span>
                      </a>
                  </li>
                  {{-- @endif --}}
                  ...
                  <li class="nav-item">
                      ...
                      <a class="nav-link" href="{{route('dr_transactions', Auth::user())}}">
                          <span class="icon">
                              <svg width="20" height="26" viewBox="0 0 20 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                                  <path d="M10.0002 5.83984C6.8411  11.2901 10.6267 11.5362 10.736C11.7821 10.8453 11.9922 10.9743 12.1666 11.123C12.3409 11.2719 12.4749 11.4524 12.5682 11.6649C12.6616 11.8774 12.7083 12.1354 12.7083 12.4389C12.7085 12.7972 12.6445 13.1023 12.517 13.3541Z"
                                      fill="white" />
                                  <path d="M9.47656 9.78886C9.47656 9.87991 9.5076 9.95436 9.56995 10.012C9.63214 10.0697 9.72552 10.1228 9.85016 10.1713V9.47925C9.60099 9.50972 9.47656 9.61285 9.47656 9.78886Z"
                                      fill="white" />
                                  <path d="M10.6348 12.3888C10.5601 12.325 10.4604 12.269 10.3359 12.2203V12.8942C10.4854 12.8821 10.5912 12.8518 10.6535 12.8032C10.7157 12.7546 10.7469 12.6909 10.7469 12.6119C10.7469 12.527 10.7095 12.4526 10.6348 12.3888Z"
                                      fill="white" />
                                  <path d="M19.2188  4.31641C14.0206 4.31641 17.2917 7.50567 17.2917 11.4258C17.2917 15.3459 14.0206 18.5352 10 18.5352Z"
                                      fill="white" />
                              </svg>

                          </span>
                          <span class="navlink-active">Doctor Transactions</span>
                      </a>
                  </li>
                  {{-- @endif --}}
                  ...
                  <li class="nav-item">
                      ...
                      <a class="nav-link" href="{{route('adm_transactions')}}">
                          ...
                          <span class="navlink-active">Admin Transactions</span>
                      </a>
                  </li>
                  {{-- @endif --}}
