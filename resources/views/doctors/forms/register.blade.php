                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Degree attained">
                                   ...
                                   <div class="row">
                                       <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Your Residence">
                                            
                                            </div>
                                       </div>
                                       <div class="col-sm-6">
                                            <div class="form-group">
                                                <label for="residency">Speciality</label>
                                                <select class="custom-select">
                                                    <option selected>Pathology</option>
                                                    <option value="1">Dermatology</option>
                                                    <option value="2">Opthamology</option>
                            ...
                            <div class="form-section">
                                ...
                                <div class="fs-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Address - Home">
                            
                                    </div>
                                
                                    <div class="form-group">
                                        <label for="w_address">Work Address</label>
                                        <input type="text" class="form-control" placeholder="Address - Work">
                            ...
                            <div class="form-section">
                                ...
                                <div class="fs-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label for="school">State/Country</label>
                                                <select class="custom-select">
                                                    <option selected>Vrancea</option>
                                                    <option value="1">ancea</option>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label for="residency">Phone</label>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <label for="school">Language</label>
                                                <select class="custom-select">
                                                    <option selected>Romanian</option>
                                        ...
                                        <div class="col-sm-6">
                                                ...
                                                <label for="school">Proficiency</label>
                                                
                                            <div class="custom-control custom-radio">
                                                <input type="radio" id="customRadio1" name="proficiency" class="custom-control-input">
                                                <label class="custom-control-label" for="customRadio1">Romanian</label>
                                            </div>
                                            <div class="custom-control custom-radio">
                                                <input type="radio" id="customRadio2" name="proficiency" class="custom-control-input">
                                                <label class="custom-control-label" for="customRadio2">English</label>
                                            </div>
                                            <div class="custom-control custom-radio">
                                                <input type="radio" id="customRadio3" name="proficiency" class="custom-control-input">
                                                <label class="custom-control-label" for="customRadio3">Romanian</label>
                                            </div>
                            ...
                            <div class="form-section">
                                ...
                                <div class="fs-body">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label for="cost" class="d-block">Cost</label>
