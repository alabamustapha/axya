...
class UsersTest extends TestCase
{
    ...
    public function test_users_database_has_expected_columns()
    {
        ...
        [
            ...
            'allergies','chronics','password','last_four','terms','is_doctor','as_doctor','allows_doctor_verify',
    ...
    /** @test  */
    public function a_user_has_many_logins()
    {
        $this->assertInstanceOf('Illuminate\Database\Eloquent\Collection', $this->user->logins);
    }
